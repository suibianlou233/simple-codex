...
const SESSION_NAME: &str = "Simple Windows Sandbox WFP";
const PROVIDER_NAME: &str = "Simple Windows Sandbox WFP";
const PROVIDER_DESCRIPTION: &str = "Persistent WFP provider for Simple Windows sandbox filters";
const SUBLAYER_NAME: &str = "Simple Windows Sandbox WFP";
const SUBLAYER_DESCRIPTION: &str = "Persistent WFP sublayer for Simple Windows sandbox filters";

// WFP identifies persistent providers, sublayers, and filters by stable GUIDs.
// Simple-owned stable WFP namespace. Changing these values would orphan
// previously installed provider objects.
const PROVIDER_KEY: GUID = GUID::from_u128(0x8cb9b842_157e_465c_8ad5_953149e2aced);
const SUBLAYER_KEY: GUID = GUID::from_u128(0x08035d05_4d80_44c0_bfec_d88c12004733);

/// Installs the persistent Simple WFP filters for `account`.
///
