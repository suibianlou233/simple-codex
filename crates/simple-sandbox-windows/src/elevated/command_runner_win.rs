...
use anyhow::Context;
use anyhow::Result;
use simple_windows_sandbox::ErrorPayload;
use simple_windows_sandbox::ExitPayload;
use simple_windows_sandbox::FramedMessage;
use simple_windows_sandbox::LocalSid;
use simple_windows_sandbox::Message;
use simple_windows_sandbox::OutputPayload;
use simple_windows_sandbox::OutputStream;
use simple_windows_sandbox::PipeSpawnHandles;
use simple_windows_sandbox::SandboxPolicy;
use simple_windows_sandbox::SpawnReady;
use simple_windows_sandbox::SpawnRequest;
use simple_windows_sandbox::StderrMode;
use simple_windows_sandbox::StdinMode;
use simple_windows_sandbox::allow_null_device;
use simple_windows_sandbox::create_readonly_token_with_caps_and_user_from;
use simple_windows_sandbox::create_workspace_write_token_with_caps_and_user_from;
use simple_windows_sandbox::decode_bytes;
use simple_windows_sandbox::encode_bytes;
use simple_windows_sandbox::get_current_token_for_restriction;
use simple_windows_sandbox::hide_current_user_profile_dir;
use simple_windows_sandbox::log_note;
use simple_windows_sandbox::parse_policy;
use simple_windows_sandbox::read_frame;
use simple_windows_sandbox::read_handle_loop;
use simple_windows_sandbox::spawn_process_with_pipes;
use simple_windows_sandbox::to_wide;
use simple_windows_sandbox::write_frame;
use std::fs::File;
...
fn spawn_ipc_process(req: &SpawnRequest) -> Result<IpcSpawnedProcess> {
    ...
    if req.tty {
        anyhow::bail!("Simple command runner does not support TTY sessions");
    }
    ...
    let spawned_pipes = spawn_process_with_pipes(
        h_token.raw(),
        &req.command,
        &effective_cwd,
        &req.env,
