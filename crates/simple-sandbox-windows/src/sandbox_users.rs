...
use simple_windows_sandbox::dpapi_protect;
...
pub const SANDBOX_USERS_GROUP: &str = "SimpleSandboxUsers";
const SANDBOX_USERS_GROUP_COMMENT: &str = "Simple sandbox internal group (managed)";
...
fn write_secrets(
    ...
    let sandbox_dir = sandbox_dir(sandbox_home);
